...
Can Body Weight(kg) be determined by Workout Frequency, Workout Type, Height, Calories Burned per Workout, and Avg BPM?
...
rq_1 <- subset(data, select = c(Weight, Workout_Frequency, Workout_Type, Calories_Burned, Height, Avg_BPM))
